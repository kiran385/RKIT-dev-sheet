        ...
        rowTemplate: function (container, item) {
            ...
            var markup = `
                <tr class='dx-row'
                    ...
                    <!-- Center-aligned and bold firstName column -->
                    <td style='text-align: center; font-weight: bold;'>${data.firstName}</td>

                    <!-- Center-aligned and bold lastName column -->
                    <td style='text-align: center; font-weight: bold;'>${data.lastName}</td>

                    <!-- Center-aligned and bold Age column with conditional text color -->
                    <td style='text-align: center; font-weight: bold; 
                               color: ${data.age >= 18 ? 'green' : 'red'};'>
                        ${data.age}
                    </td>

                    <!-- Center-aligned and bold DOB column -->
                    <td style='text-align: center; font-weight: bold;'>${data.dob}</td>
                </tr>
            `;
