$(() => {
    ...
    $('#gridContainer').dxDataGrid({
        ...
        onCellPrepared: function (e) {
            if (e.rowType === 'data') {
                if (e.column.dataField === 'id' && e.value % 2 == 0) {
                    e.cellElement.css({ 'height': '50px' });
                }

                if (e.column.dataField === 'firstName' && e.value.toLowerCase().includes('e')) {
                    e.cellElement.css({ 'font-weight': 'bold', 'color': 'gold' });
                }
